...
default[:sonar][:http_proxy][:admin_email]  = "ops@example.com"
default[:sonar][:http_proxy][:host_aliases] = []
default[:sonar][:http_proxy][:ssl_pem]      = nil # set if using existing certificate
default[:sonar][:http_proxy][:ssl_key]      = nil # set if using existing certificate
default[:sonar][:http_proxy][:state]        = nil # set if using self-signed certificate
default[:sonar][:http_proxy][:location]     = nil # set if using self-signed certificate
default[:sonar][:http_proxy][:organization] = nil # set if using self-signed certificate
default[:sonar][:http_proxy][:server_name]  = nil # set if using self-signed certificate
